...
public class MachineLearningModelCas {
	...
	private final static String ML_CAS_PREDICTION = "ml-infection-prediction.csv";
	...
	public static void main(String[] args) throws Exception {
		...
		CSVWriter csvWriter = new CSVWriter(new FileWriter(ML_CAS_PREDICTION), CSVWriter.DEFAULT_SEPARATOR,
