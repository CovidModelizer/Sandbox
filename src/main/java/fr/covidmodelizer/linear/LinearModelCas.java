...
public class LinearModelCas {
	...
	private final static String LIN_CAS_PREDICTION = "lin-cas-prediction.csv";

	public static void main(String[] args) throws Exception {
		List<String[]> data = new CSVReaderBuilder(new FileReader(DATA_LIN_CAS_CSV))
		...
		atts.add(new Attribute("cumul_" + data.get(0)[1]));
		...
		CSVWriter csvWriter = new CSVWriter(new FileWriter(LIN_CAS_PREDICTION), CSVWriter.DEFAULT_SEPARATOR,
